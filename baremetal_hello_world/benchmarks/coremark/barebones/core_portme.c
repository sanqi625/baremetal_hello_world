...
*/
//uart_element_t uart_element;

//void _putchar(char character) {
//    uart_put_char(&uart_element, character);
//}
...
portable_init(core_portable *p, int *argc, char *argv[])
{
    ...
    //uart_init(&uart_element, UART_BASE_ADDR);
    ...
    {
        #ifdef ARCH64
            ee_printf("Macro \"ARCH64\" is defined.\n");
        #endif
        
        ee_printf("sizeof(ee_u64) =%d\n",sizeof(ee_u64));
        ee_printf("sizeof(ee_u32) =%d\n",sizeof(ee_u32));
        ee_printf("sizeof(ee_ptr_int) =%d\n",sizeof(ee_ptr_int));
        ee_printf("sizeof(ee_u8)      =%d\n",sizeof(ee_u8 *));
