# 0 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/store_access.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/store_access.c"
...
# 2 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/store_access.c" 2
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/include/riscv_asm.h" 1
# 3 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/store_access.c" 2
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/include/riscv_encoding.h" 1
# 4 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/store_access.c" 2
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/include/riscv_asm.h" 1
# 5 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/store_access.c" 2
...
void sbi_store_access_handler()
{
    ...
    ({ unsigned long __v = (unsigned long)(0x1818); __asm__ __volatile__("csrw " "pmpcfg0" ", %0" : : "rK"(__v) : "memory"); });

    printf_("/*============== Please check store access priviledge !!!==============*/\n");
