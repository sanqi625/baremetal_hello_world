# 0 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/illegal_inst.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/illegal_inst.c"
...
# 2 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/illegal_inst.c" 2
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/include/riscv_asm.h" 1
# 3 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/illegal_inst.c" 2
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/include/riscv_encoding.h" 1
# 4 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/illegal_inst.c" 2
...
void sbi_illegal_insn_handler()
{
    ...
    printf_("/*============== Please check instruction !!!==============*/\n");
