# 0 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/ebreak.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/ebreak.c"
...
# 2 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/ebreak.c" 2
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/include/riscv_asm.h" 1
# 3 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/ebreak.c" 2
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/include/riscv_encoding.h" 1
# 4 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/trap_handle_func/ebreak.c" 2

void sbi_ebreak_handler()
{

    printf_("/*============== Not Enter in Debug mode!!!==============*/\n");

    unsigned int mpec = ({ register unsigned long __v; __asm__ __volatile__("csrr %0, " "0x341" : "=r"(__v) : : "memory"); __v; });
    printf_("EBREAK PC value = %0x\n",mpec);
    ...
    printf_("EBREAK NEXT PC value = %0x\n",next_pc_val);
