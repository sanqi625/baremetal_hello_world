# 0 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/init.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/init.c"
...
# 2 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/init.c" 2

# 1 "/data/usr/qijiahuan/baremetal_hello_world/driver/uart.h" 1
...
# 6 "/data/usr/qijiahuan/baremetal_hello_world/driver/uart.h"
...
# 4 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/init.c" 2
...
# 5 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/init.c" 2
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/pmp_init.h" 1
void pmp_init();
# 6 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/init.c" 2
...
void init() {
    ...
    uart_init(&uart, 0xC0001000);
    printf_("Bare Metal Init Start.\n");
    pmp_init();
    ...
    printf_("Bare Metal Init Finished.\n");
}
