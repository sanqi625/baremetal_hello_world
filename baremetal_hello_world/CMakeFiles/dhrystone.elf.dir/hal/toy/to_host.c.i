# 0 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/to_host.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/to_host.c"
...
# 2 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/to_host.c" 2



# 4 "/data/usr/qijiahuan/baremetal_hello_world/hal/toy/to_host.c"
void to_host() {
    volatile uint32_t * to_host_ptr = (volatile uint32_t *)0xc0000000;
    *to_host_ptr = 1;
}
